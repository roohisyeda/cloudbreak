...
public class ClusterCreationActions {
    ...
    public Action<?, ?> clusterProxyGatewayRegistrationAction() {
        return new AbstractStackCreationAction<>(HandleClusterCreationSuccessSuccess.class) {
            @Override
            protected void doExecute(StackContext context, HandleClusterCreationSuccessSuccess payload, Map<Object, Object> variables) {
                sendEvent(context);
            }
